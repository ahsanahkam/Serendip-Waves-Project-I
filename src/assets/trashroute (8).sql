...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2025 at 05:32 PM
...
INSERT INTO `contact_us` (`contact_id`, `user_id`, `admin_id`, `name`, `email`, `subject`, `message`, `created_at`) VALUES
(1, NULL, NULL, 'jayakulan', 'customer@gmail.com', 'hi', 'hello', '2025-07-06 05:14:48');
...
(14, 19, 'Glass', 3, 6.93447800, 79.84277800, 'Request received', '2025-07-10 19:34:47', '123456', 0),
(15, 20, 'Metal', 7, 7.29057200, 80.63372800, 'Request received', '2025-07-10 19:34:47', '123456', 0),
(16, 21, 'Paper', 10, 6.05351900, 80.22097800, 'Request received', '2025-07-10 19:34:47', '098765', 0),
(17, 23, 'Plastic', 4, 6.92736900, 79.86138000, 'Request received', '2025-07-10 19:34:47', '654321', 0),
(20, 58, 'Glass', 2, 8.31135600, 80.40365900, 'Request received', '2025-07-10 19:34:47', '008684', 0),
...
(89, 'Gdfgdf', 'adadfsdf@gmail.com', '$2y$10$lR0g4HxI.2kvwDM.LSEnWO53sQwJfPoDtuJ9pVLmdmBP.Tu4lSmJy', '0776104689', '643 KKS road Jaffna', 'customer', 'active', '2025-07-26 19:27:51');
...
--
ALTER TABLE `routes`
  MODIFY `route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `route_request_mapping`
--
ALTER TABLE `route_request_mapping`
  MODIFY `mapping_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
...
--
ALTER TABLE `contact_us`
  ADD CONSTRAINT `contact_us_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `registered_users` (`user_id`) ON DELETE SET NULL,
